...
\newpage
\section* {\centerline{Section 8: Experimental Results, Iteration 2} \newline}
\addcontentsline{toc}{section}{\large Section 8: Experimental Results, Iteration 2}
...
\begin{figure} [H]
    \includegraphics[width = \textwidth, keepaspectratio]{dataset_3_old_static.png}
    \caption{Static on 3-D Data set} 
\end{figure}
                    
\begin{figure} [H]
    \includegraphics[width = \textwidth, keepaspectratio]{dataset_3_new_static.png}
\caption{Static on 3-D Data set, After addition/deletion of Points} 
\end{figure}
            
\begin{figure} [H]
\includegraphics[width = \textwidth, keepaspectratio]{dataset_3_incr.png}
\caption{Incremental on 3-D Data set} 
\end{figure}
                    
\begin{figure} [H]
\includegraphics[scale = 0.5]{traffic_data_old_static.png}
\caption{Static on Traffic Volume Data set} 
\end{figure}
            
\begin{figure} [H]
\includegraphics[scale = 0.5]{traffic_data_new_static.png}
\caption{Static on Traffic Volume Dataset, After addition/deletion of Points} 
\end{figure}
            
\begin{figure} [H]
\includegraphics[scale = 0.5]{traffic_data_incr.png}
...
\section*{Graphical Metric Plots}
    ...
    \begin{figure} [H]
        \includegraphics[width = 0.6\textwidth, keepaspectratio]{time_plot.png}
        \caption{Time Comparison}    
    \end{figure}  

    \begin{figure} [H]
        \includegraphics[width = 0.6\textwidth, keepaspectratio]{memory_plot.png}
        \caption{Memory Comparison}    
    \end{figure}  

    \begin{figure} [H]
        \includegraphics[width = 0.6\textwidth, keepaspectratio]{cpu_usage_plot.png}
